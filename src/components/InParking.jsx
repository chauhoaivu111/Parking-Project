...
const Inparking
 = () =>{
  ...
  const [tableData, setTableData] = useState([
    ...
    { name: "Đao Văn Ngọc Hoàng",  Plates: 7845621590, Date:  "11-01-2022", current: "true", Location: "505" },
    { name: "Hà Đức Tuấn",  Plates: 741852912, Date:  "11-01-2022", current: "true", Location: "506" },
    { name: "Ngô Văn kiều",  Plates: 9876543210, Date:  "11-01-2022", current: "true", Location: "303" },
    { name: "Trần Thanh Thoa",  Plates: 7894561230, Date:  "11-01-2022", current: "true", Location: "107"},
    { name: "Nguyện Thị Ngọc", Plates: 7845621590, Date:  "11-01-2022", current: "true", Location: "207" },
    { name: "Bảo Gia Hân",  Plates: 741852912, Date: "11-01-2022" , current: "true", Location: "310" },
    { name: "Trịnh Quốc PHúc",  Plates: 9876543210, Date: "11-01-2022", current: "true", Location: "410" },
  ])
  const columns = [
